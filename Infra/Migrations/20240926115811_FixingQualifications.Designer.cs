...
namespace Infra.Migrations
{
    ...
    [Migration("20240926115811_FixingQualifications")]
    partial class FixingQualifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentQualification", b =>
                {
                    ...
                    b.HasKey("StudentId", "QualificationId");
            ...
            modelBuilder.Entity("TutorQualification", b =>
                {
                    b.Property<Guid>("TutorId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("TutorId", "QualificationId");
            ...
            modelBuilder.Entity("StudentQualification", b =>
                {
                    b.HasOne("Domain.Entities.Qualification", null)
                        .WithMany()
                        .HasForeignKey("QualificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
