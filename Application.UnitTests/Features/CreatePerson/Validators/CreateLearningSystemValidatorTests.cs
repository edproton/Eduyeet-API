...
namespace Application.UnitTests.Features.CreatePerson.Validators;
...
public class CreatePersonCommandValidatorTests
{
    ...
    {
        var command = new CreatePersonCommand("", "test@example.com", "password", PersonTypeEnum.Student);
    ...
    {
        var command = new CreatePersonCommand("A", "test@example.com", "password", PersonTypeEnum.Student);
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(c => c.Name)
    ...
    {
        var command = new CreatePersonCommand(new string('A', 51), "test@example.com", "password", PersonTypeEnum.Student);
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(c => c.Name)
    ...
    {
        var command = new CreatePersonCommand("John Doe", "", "password", PersonTypeEnum.Student);
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new CreatePersonCommand("John Doe", "invalid-email", "password", PersonTypeEnum.Student);
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(c => c.Email)
    ...
    public void ShouldHaveErrorWhenEmailIsTooLong()
    {
        ...
        var command = new CreatePersonCommand("John Doe", longEmail, "password", PersonTypeEnum.Student);
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(c => c.Email)
    ...
    {
        var command = new CreatePersonCommand("John Doe", "test@example.com", "", PersonTypeEnum.Student);
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new CreatePersonCommand("John Doe", "test@example.com", "short", PersonTypeEnum.Student);
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(c => c.Password)
    ...
    {
        var command = new CreatePersonCommand("John Doe", "test@example.com", "password123", (PersonTypeEnum)99);
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new CreatePersonCommand("John Doe", "test@example.com", "password123", PersonTypeEnum.Student);
        var result = _validator.TestValidate(command);
